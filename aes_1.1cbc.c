...
/* 4 words = 16 bytes key length for AES128, for 192, 256, it shd be 6,8 resp.
 ...
 */ 
//#ifndef Nk
//#define Nk 4      //already defined in cbc file
//#endif
#if Nk==4
...
void encrypt(uch *state, uch *expandedKey){ //for 128-bit AES only, need examples
    ...
    for(int i=1;i<=AES_ROUNDS;i++){
        ...
        for(int j=0;j<4;j++) subBytes(state+j*4);   // step 1
